...
const oauth2Client = new OAuth2(
  ...
  process.env.GOOGLE_OAUTH2_CLIENT_REFRESH_TOKEN,
  process.env.GOOGLE_OAUTH2_PLAYGROUND
)
...
const sendEmail = async (options) => {
  ...
  const transport = nodemailer.createTransport({
    ...
    auth: {
      ...
      refreshToken: process.env.GOOGLE_OAUTH2_CLIENT_REFRESH_TOKEN,
      accessToken
    }
  })
                            ...
                            <tr>
                              <td valign="top" align="center" style="padding:0;Margin:0;width:660px">
                                <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                  <tr>
                                    <td style="padding:0;Margin:0;font-size:0px" align="center"><img src="https://tqaiig.stripocdn.email/content/guids/CABINET_2663efe83689b9bda1312f85374f56d2/images/10381620386430630.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="100"></td>
                                  </tr>
                                  <tr>
                                    <td align="center" style="padding:0;Margin:0"><h2 style="Margin:0;line-height:43px;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;font-size:36px;font-style:normal;font-weight:normal;color:#333333">${options.titleEmail}</h2></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td class="es-m-p0r" align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px;padding-right:40px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:24px;color:#333333;font-size:16px">Thank you for using Trello!</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:24px;color:#333333;font-size:16px"><br></p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Montserrat, sans-serif;line-height:24px;color:#333333;font-size:16px">Please confirm that <strong><a target="_blank" href="mailto:${options.email}" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#1d7bb6;font-size:16px">${options.email}</a></strong>&nbsp;is your email address by clicking on the button below</p></td>
                                  </tr>
                                  <tr>
                                    <td class="es-m-txt-c" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0" align="center">
                                      <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:40% !important;display:inline-table" width="40%" height="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                  ...
                                  <tr>
                                    <td class="es-m-txt-l" align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><span class="es-button-border" style="border-style:solid;border-color:#999999;background:#1d7bb6;border-width:1px;display:inline-block;border-radius:0px;width:auto"><a href="${options.url}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#ffffff;font-size:16px;border-style:solid;border-color:#1d7bb6;border-width:10px 30px 10px 30px;display:inline-block;background:#1d7bb6;border-radius:0px;font-family:Montserrat, sans-serif;font-weight:normal;font-style:normal;line-height:19px;width:auto;text-align:center">${options.action}</a></span></td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
